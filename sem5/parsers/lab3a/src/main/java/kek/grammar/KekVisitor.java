...
public interface KekVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link KekParser#forArgsDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitForArgsDecl(KekParser.ForArgsDeclContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link KekParser#forStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitForStatement(KekParser.ForStatementContext ctx);
	/**
