...
public interface KekListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link KekParser#forArgsDecl}.
	 * @param ctx the parse tree
	 */
	void enterForArgsDecl(KekParser.ForArgsDeclContext ctx);
	/**
	 * Exit a parse tree produced by {@link KekParser#forArgsDecl}.
	 * @param ctx the parse tree
	 */
	void exitForArgsDecl(KekParser.ForArgsDeclContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link KekParser#forStatement}.
	 * @param ctx the parse tree
	 */
	void enterForStatement(KekParser.ForStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link KekParser#forStatement}.
	 * @param ctx the parse tree
	 */
	void exitForStatement(KekParser.ForStatementContext ctx);
	/**
